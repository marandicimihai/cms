...
) : IEmailSender<ApplicationUser>
{
    ...
    public async Task SendPasswordResetLinkAsync(ApplicationUser user, string email, string resetLink)
    {
        ...
        {
            logger.LogInformation(ex, "There was an error when sending password reset link email to {userId}.", user.Id);
        }
    }
    ...
    public async Task SendPasswordResetCodeAsync(ApplicationUser user, string email, string resetCode)
    {
        ...
        {
            logger.LogInformation(ex, "There was an error when sending password reset code email to {userId}.", user.Id);
        }
    }
}